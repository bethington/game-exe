...
This section documents all 223 custom-named functions identified in the Game.exe binary through reverse engineering with Ghidra. Functions are organized by category for easy navigation.

### Summary Statistics
- **Total Functions**: 223 (100% custom named)
- **CRT Functions**: 89 (39.9%)
- **Game Logic**: 48 (21.5%)
- **DLL Management**: 34 (15.2%)
- **Configuration**: 18 (8.1%)
- **Service Support**: 7 (3.1%)
- **Utility**: 27 (12.1%)

---

### 1. CRT Initialization & Runtime (89 functions)

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `CRTStartup` | `0x0040122e` | **Entry point** - Main CRT initialization |
| `__cinit` | `0x0040234e` | Initialize C++ global constructors |
| `__initterm` | `0x00402336` | Call initialization table functions |
| `__setargv` | `00402a60` | Parse command line into argc/argv |
| `ParseCommandLine` | `004028f4` | Parse command line arguments |
| `__wincmdln` | `004027d0` | Get Windows command line |
| `InitializeEnvironmentVariables` | `0040282d` | Setup environment block |
| `GetEnvironmentStringsAscii` | `00402b02` | Retrieve environment strings |
| `InitializeFileHandling` | `00402c24` | Initialize file I/O subsystem |
| `___initstdio` | `004034a1` | Setup stdin/stdout/stderr |
| `__heap_init` | `00402ec4` | Initialize heap manager |
| `___heap_select` | `00402eaa` | Select heap algorithm |
| `InitializeSmallBlockHeap` | `004051d8` | SBH initialization |
| `__RTC_Initialize` | `00402e22` | Runtime checks initialization |
| `__mtinit` | `00401f44` | Initialize multithreading |
| `TlsAllocWrapper` | `00401d66` | Allocate TLS slot |
| `__getptd` | `00401d8c` | Get per-thread data |
| `__mtinitlocks` | `004038e5` | Initialize critical sections |
| `InitializeCRTLockByNumber` | `00403998` | Setup lock by index |
| `___security_init_cookie` | `00404035` | Initialize stack cookie |
| `___initmbctable` | `00404017` | Initialize MBCS tables |
| `__setmbcp` | `00403ec7` | Set multibyte code page |
| `InitializeCodePageSettings` | `00403d33` | Setup code page |
| `InitializeSBCSSettings` | `00403b6f` | Single-byte charset init |
| `InitializeCharTypeTables` | `00403b98` | Character type tables |
| `___updatetlocinfo` | `0040227a` | Update thread locale info |
| `___updatetlocinfo_lk` | `004021b9` | Locked locale update |
| `ProcessExitSequence` | `004023b8` | Termination sequence |
| `__exit` | `0040248c` | Exit with cleanup |
| `_exit` | `0040247b` | Quick exit |
| `__cexit` | `0040249d` | Console exit |
| `ExitProgram` | `004024ac` | Final exit wrapper |
| `CorExitProcessWrapper` | `004022f4` | COM runtime exit |
| `__mtterm` | `00401d6f` | Terminate multithreading |
| `__mtdeletelocks` | `0040392e` | Delete all CRT locks |
| `__onexit` | `00404fb6` | Register exit handler |
| `__onexit_lk` | `00404f0e` | Locked onexit |
| `_atexit` | `00404fee` | Register atexit handler |
| `AcquireOnexitLock` | `00402324` | Lock onexit table |
| `ReleaseOnexitLock` | `00404fe8` | Unlock onexit table |

**Memory Management (20 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `_malloc` | `004037b2` | Allocate memory |
| `_free` | `00403602` | Free memory block |
| `ReallocateMemoryBlock` | `00406afe` | Resize allocation |
| `_msize` | `00406cb0` | Get block size |
| `__heap_alloc` | `0040370b` | Low-level heap alloc |
| `AllocateMemoryWithRetry` | `00403786` | Alloc with fallback |
| `AllocateMemoryWithFallback` | `00403a69` | Alloc with handler |
| `__callnewh` | `004063bb` | Call new handler |
| `AllocateSmallBlockHeapMemory` | `004059ff` | SBH allocator |
| `AllocateSmallBlockHeapRegion` | `00405563` | SBH region alloc |
| `AllocateSmallBlockHeapGroup` | `0040561a` | SBH group alloc |
| `FreeSBHMemoryBlock` | `0040524b` | Free SBH block |
| `ResizeSmallHeapBlock` | `00405720` | SBH realloc |
| `___sbh_find_block` | `00405220` | Find SBH block |
| `UnlockHeapLock` | `00403655` | Release heap lock |
| `UnlockHeap` | `00403b2f` | Release heap mutex |
| `ReleaseHeapLock` | `00406c66` | Unlock heap (variant 1) |
| `ReleaseHeapLock` | `00406d1d` | Unlock heap (variant 2) |

**File I/O (22 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `__write` | `00403388` | Write to file descriptor |
| `__lseek` | `00403121` | Seek file position |
| `__lseek_lk` | `004030ad` | Locked seek |
| `__close` | `004072b4` | Close file handle |
| `CloseFileDescriptor` | `00407231` | Close fd wrapper |
| `__get_osfhandle` | `00406028` | Get OS file handle |
| `__free_osfhnd` | `00405fa9` | Release OS handle |
| `__isatty` | `00403477` | Check if TTY |
| `WriteFileHandleWithTextConversion` | `004031cc` | Write with CRLF |
| `SeekFile64Locked` | `0040612b` | 64-bit locked seek |
| `__flush` | `00406249` | Flush file buffer |
| `FlushFileStream` | `004062a6` | Flush stream |
| `FlushAllFileStreams` | `004062d4` | Flush all streams |
| `FlushAllOpenFileStreams` | `004061ae` | Flush all open files |
| `FlushAllStreamsAndCount` | `004063a9` | Flush with count |
| `FlushOSFileBuffers` | `0040710a` | OS-level flush |
| `CloseFileStream` | `004070b9` | Close FILE* stream |
| `__fclose_lk` | `0040706d` | Locked fclose |
| `AcquireFileHandleLock` | `00406069` | Lock file handle |
| `ReleaseFhandleLock` | `00406109` | Release handle lock |
| `ReleaseFhandleLockWrapper` | `004071aa` | Release lock wrapper |
| `ReleaseFileHandleLock` | `0040732b` | Release handle lock |
| `__unlock_fhandle` | `004031a8` | Unlock file handle |
| `UnlockFileHandle` | `0040340f` | Unlock handle wrapper |
| `UnlockFileHandleTable` | `00406100` | Unlock handle table |
| `FreeFileBuffer` | `0040734f` | Free stream buffer |
| `GetBufferForFileStream` | `00403433` | Get stream buffer |

**String & Formatting (11 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `_sprintf` | `00401000` | Format string |
| `vfprintf` | `004015aa` | Variable arg fprintf |
| `FormatStringBufferThunk` | `00407466` | Format buffer thunk |
| `_strlen` | `00403680` | String length |
| `_strncpy` | `004047c0` | Copy N characters |
| `_strncmp` | `00401060` | Compare N chars |
| `_strcspn` | `00404770` | Scan for charset |
| `_strpbrk` | `00404de0` | Find char in set |
| `CopyStringOptimized` | `00404670` | Fast string copy |
| `StringConcatenate` | `00404680` | Concatenate strings |
| `CompareStringsCaseInsensitive` | `004071d0` | Case-insensitive compare |
| `___ascii_stricmp` | `00406ab0` | ASCII case compare |
| `TokenizeString` | `00401099` | Parse tokens |

**Memory Operations (5 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `_memcpy` | `004049e0` | Copy memory |
| `_memset` | `004048f0` | Fill memory |
| `_memmove` | `00406d30` | Move memory (overlapping) |
| `CompareMemoryBuffers` | `00404d20` | Compare memory |
| `MemCopyThunk` | `0040746c` | Memory copy thunk |

**Locking & Synchronization (18 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `__lock` | `00403a38` | Acquire CRT lock |
| `__unlock` | `004022ac` | Release CRT lock (variant 1) |
| `__unlock` | `0040377d` | Release CRT lock (variant 2) |
| `ReleaseCriticalSectionByIndex` | `004035df` | Release by index |
| `ReleaseCriticalSectionByLockId` | `00403983` | Release by ID |
| `ReleaseCriticalSectionIndex8` | `0040232d` | Release index 8 |
| `ReleaseLock10` | `00403a2f` | Release lock 10 |
| `ReleaseLock12` | `00401f3b` | Release lock 12 |
| `ReleaseThreadLock13` | `00401f2f` | Release lock 13 |
| `ValidateLockStateAndUnlock` | `00402467` | Check and unlock |
| `LockFileStream` | `0040355e` | Lock FILE* |
| `AcquireStreamLock` | `0040358d` | Acquire stream lock |
| `UnlockFileStream` | `004035b0` | Unlock FILE* |
| `ReleaseStreamLock` | `00406374` | Release stream lock |
| `UnlockFileStreamWrapper` | `00407102` | Unlock wrapper |
| `ReleaseFileIOLock` | `00406240` | Release I/O lock |
| `ReleaseGlobalIOLock` | `004063a0` | Release global lock |
| `ReleaseMbcpCriticalSection` | `0040400e` | Release MBCP lock |
| `___crtInitCritSecNoSpinCount@8` | `0040513d` | Init critical section |
| `InitializeCriticalSectionWithSpinCount` | `0040514d` | Init with spin count |

**Locale & Character Types (13 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `GetMultiByteCharType` | `00402072` | Get MB char type |
| `CheckMultibyteCharacterType` | `004050f9` | Check MB type |
| `__ismbblead` | `0040512c` | Check lead byte |
| `MapCodePageToMaxCharSize` | `00403b40` | Get CP max char size |
| `GetStringTypeA` | `004041e6` | Get string type |
| `FreeThreadLocaleInfo` | `004020e9` | Free thread locale |
| `FreeLocaleTimeData` | `004043a0` | Free time data |
| `FreeLocaleNumericFields` | `00404530` | Free numeric data |
| `___free_lconv_mon` | `0040458f` | Free monetary data |
| `RetrieveLocaleCodePage` | `004067ac` | Get locale CP |
| `_wctomb` | `00403824` | Wide char to MB |
| `ConvertWideCharToMultibyte` | `004037c4` | Wide to MB |
| `MapStringWithUnicodeSupport` | `004063d6` | Map string |
| `ConvertStringBetweenCodePages` | `004067f3` | Convert CP |

**Error Handling & Exceptions (15 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `__SEH_prolog` | `00402f18` | SEH frame setup (28 refs) |
| `__SEH_epilog` | `00402f53` | SEH frame cleanup (26 refs) |
| `__global_unwind2` | `00404e20` | Global exception unwind |
| `__local_unwind2` | `00404e62` | Local exception unwind |
| `SaveExceptionContext` | `00404ef6` | Save exception state |
| `CleanupExceptionFrame` | `00403052` | Cleanup SEH frame |
| `RtlUnwind` | `0040744e` | System unwind |
| `ValidateExceptionHandlerStructure` | `00405cfb` | Validate SEH chain |
| `FilterExceptionByCode` | `0040266c` | Filter by code |
| `__amsg_exit` | `004011e5` | Exit with message |
| `ExitWithFastErrorHandler` | `0040120a` | Fast error exit |
| `DisplayRuntimeError` | `004024bb` | Show error message |
| `___crtMessageBoxA` | `00405000` | Show message box |
| `__FF_MSGBANNER` | `00402633` | Display banner |
| `ReportSecurityFailureAndExit` | `00402033` | Security failure |
| `ReportSecurityFailureAndTerminate` | `0040409b` | Security terminate |
| `ValidateStackCookie` | `00402064` | Check stack cookie |
| `TerminateOnFloatingPointError` | `004063b2` | FP error handler |
| `__resetstkoflw` | `004069cd` | Reset stack overflow |

**Misc CRT Utilities (8 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `_atol` | `00401158` | ASCII to long (variant 1) |
| `_atol` | `004011e0` | ASCII to long (variant 2) |
| `__chkstk` | `00403070` | Stack probe |
| `__flsbuf` | `00401403` | Flush buffer |
| `WriteCharacterToStream` | `0040151c` | Write char |
| `WriteCharacterRepeatedly` | `0040154f` | Write char N times |
| `OutputStringToStream` | `00401573` | Output string |
| `GetThreadErrnoAddress` | `00405f24` | Get errno address |
| `GetDosErrnoPointer` | `00405f2d` | Get doserrno address |
| `__dosmaperr` | `00405f36` | Map DOS error |
| `Multiply64BitIntegers` | `004022c0` | 64-bit multiply |
| `UnsignedLongDivideWithRemainder` | `00403850` | Divide with remainder |
| `DecrementValue` | `00407380` | Atomic decrement |

---

### 2. Game Logic & Initialization (48 functions)

**Main Entry & Initialization (8 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `D2ServerMain` | `00408540` | **Main game entry point** |
| `InitializeAndRunD2Server` | `00408250` | Initialize and run server |
| `InitializeAndRunGameMainLoop` | `00407600` | Main loop initialization |
| `InitializeCommandLineSettings` | `00408000` | Setup command line config |
| `SetupProcessSecurityRestrictions` | `00408120` | Apply security policy |
| `InitializeServerSubsystem` | `00407490` | Server subsystem init |
| `InitializeStormSubsystem` | `004074ae` | Storm.dll initialization |
| `InitializeGameData` | `004074a8` | Game data initialization |

**Graphics & Rendering (13 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `InitializeGraphicsSubsystem` | `004074d8` | Graphics initialization |
| `InitializeRendererThunk` | `004074ea` | Renderer setup |
| `ValidateSystemRequirementsThunk` | `004074e4` | Check system requirements |
| `GetDefaultScreenMode` | `004074b4` | Get screen mode |
| `PrepareGraphicsShutdown` | `004074c0` | Prepare gfx shutdown |
| `ShutdownGraphicsThunk` | `0040750e` | Shutdown graphics |
| `CloseEngineSubsystem` | `004074d2` | Close engine |
| `GetWindowHandleThunk` | `00407526` | Get window handle |
| `SetFPSDisplayMode` | `00407502` | Toggle FPS display |
| `SetFramerateLock` | `00407508` | Lock framerate |
| `EnableWideAspectRatio` | `00407514` | Enable widescreen |
| `ApplyGammaCorrection` | `00407520` | Apply gamma |
| `LoadVideoSettingsFromConfigFile` | `00407a80` | Load video config |

**Audio (4 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `InitializeDirectSound` | `004074f6` | DirectSound init |
| `EnableSound` | `0040751a` | Enable audio |
| `ShutdownSubsystem6Thunk` | `004074fc` | Shutdown audio |

**UI & Menu (3 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `CleanupMenuSystem` | `004074f0` | Cleanup menus |
| `InitializeSubsystem2Thunk` | `004074ba` | UI subsystem init |
| `InitializeSubsystem3Thunk` | `00407496` | UI subsystem 3 |

**Event Handling (2 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `CloseAllEventHandlersThunk` | `0040749c` | Close event handlers |
| `ShutdownExternalSubsystemThunk` | `004074a2` | Shutdown external |

**DLL Loading & Management (18 functions)**:

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `LoadDllAndQueryInterface` | `00407550` | Load DLL + get interface |
| `LoadGameStateDll` | `004075d0` | Load game state DLL |
| `SafeGetProcAddress` | `00407ec0` | Safe GetProcAddress |
| `AllocateMemoryThunk` | `00407478` | Memory alloc thunk |
| `FreeMemoryThunk` | `00407484` | Memory free thunk |

---

### 3. Configuration & Command Line (18 functions)

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `ParseCommandLineIntoConfig` | `00407c90` | Parse cmdline to config |
| `ExtractAndLookupCommandLineOption` | `00407b70` | Extract option |
| `SearchCommandLineOptionTable` | `004078e0` | Search option table |
| `ExtractModStateKeywordFromCmdLine` | `00407e00` | Extract mod keyword |
| `IsDelimiterChar` | `004078b0` | Check delimiter |
| `ConvertStringToLowercase` | `00407940` | To lowercase |
| `GetTruncatedDirectoryPath` | `00407960` | Get directory |
| `SanitizeStringInPlace` | `004079d0` | Sanitize string |
| `GetInstallDirectory` | `0040747e` | Get install path |
| `RegReadStringValue` | `00407454` | Read registry string |
| `RegQueryDwordValue` | `00407460` | Read registry DWORD |
| `WriteRegistryDwordValue` | `0040745a` | Write registry DWORD |
| `SetRegistryStringValue` | `00407472` | Write registry string |
| `MigrateRegistrySettingsFromBeta` | `00407ee0` | Migrate beta settings |
| `ProcessVersionStringOrdinal10019` | `0040748a` | Process version string |

---

### 4. Service Support (7 functions)

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `OpenDiablo2Service` | `00407d60` | Open as Windows Service |
| `ServiceMainD2Server` | `00408450` | Service main entry |
| `ServiceControlHandler` | `00407db0` | Service control handler |
| `InitializeServiceDispatcher` | `004084b0` | Start service dispatcher |

---

### 5. Utility Functions (27 functions)

| Function Name | Address | Purpose |
|---------------|---------|---------|
| `ReturnTrue` | `00408110` | Always return TRUE |

---

## Function Cross-Reference Statistics

**Most Referenced Functions (Top 10)**:

1. `_free` - **91 references** (memory deallocation)
2. `__SEH_prolog` - **28 references** (exception handling setup)
3. `__SEH_epilog` - **26 references** (exception handling cleanup)
4. `GetThreadErrnoAddress` - **17 references** (errno access)
5. `ReleaseCriticalSectionByLockId` - **17 references** (lock release)
6. `__lock` - **17 references** (lock acquire)
7. `_malloc` - **16 references** (memory allocation)
8. `__getptd` - **12 references** (per-thread data)
9. `_strlen` - **12 references** (string length)
10. `GetDosErrnoPointer` - **10 references** (doserrno access)

**Unreferenced Functions (0 xrefs)**:

- `Multiply64BitIntegers` (`0x004022c0`)
- `LoadGameStateDll` (`0x004075d0`)
- `IsDelimiterChar` (`0x004078b0`)
- `SearchCommandLineOptionTable` (`0x004078e0`) - **Note**: Actually used but xref not detected
- `ConvertStringToLowercase` (`0x00407940`)
- `SafeGetProcAddress` (`0x00407ec0`)
- `MigrateRegistrySettingsFromBeta` (`0x00407ee0`)
- `OpenDiablo2Service` (`0x00407d60`)
- `CleanupExceptionFrame` (`0x00403052`)
